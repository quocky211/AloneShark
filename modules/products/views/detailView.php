            ...
            <div class="section" id="detail-product-wp">
                <div class="section-detail clearfix">
                    ...
                    <div class="info fl-right">
                        ...
                        <div class="desc">
                            <p>Giá bán :<?php echo number_format($data['1']['price']); ?></p>   
                        </div>
                        ...
                        <div id="num-order-wp">
                            ...
                            <input disabled type="text" name="" style="width: 40px;text-align: center;" value="1">
                        </div>
                        <a href="<?php $id = $data['1']['id']; if(!empty($_SESSION['id_customer'])) 
                                                                    $urlll ="?modules=carts&controllers=index&action=add&id=$id" ;
                                                                else 
                                                                    $urlll ="?modules=users&controllers=index&action=index&report=1" ;
                                                                echo $urlll;?> " title="Thêm giỏ hàng" class="add-cart">Thêm giỏ hàng</a>
                    </div>
                </div>
            </div>
                        ...
                        <?php if(!empty($data{'2'})) foreach ($data['2'] as  $value) {?>
                            <li>
                                ...
                                <div class="action clearfix">
                                    <a href="<?php $id = $value['id']; if(!empty($_SESSION['id_customer'])) 
                                                                            $urlll ="?modules=carts&controllers=index&action=add&id=$id" ;
                                                                        else 
                                                                            $urlll ="?modules=users&controllers=index&action=index&report=1" ;
