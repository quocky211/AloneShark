                    ...
                    <div class="section" id="list-product-wp">
                        <div class="section-head clearfix">
                            ...
                            <div class="filter-wp fl-right">
                                <p class="desc">Hiển thị 
                                    <?php if(!empty($data['0'])) echo count($data['0']);else echo '0' ;?> kết quả trong 
                                    <?php if(!empty($data['4'])) echo count($data['4']);else echo '0' ; ?> kết quả</p>
                            </div>
                        </div>
                            ...
                            <ul class="list-item clearfix">
                                <?php if(!empty($data['0'])) foreach ($data['0'] as $key => $value) {?>
                                    <li>
                                        ...
                                        <div class="price">
                                            <span class="new"><?php echo number_format($value['promotional_price']).' VNĐ'; ?></span>
                                            <span class="old"><?php echo number_format($value['price']).' VNĐ'; ?></span>
                                        </div>
                        ...
                        <div class="section-detail">
                            <ul class="list-item clearfix">
                                ...
                                <li>
                                    ...
                                    href="?modules=search&controllers=index&action=search&page=<?php echo $i; ?>&key_word=<?php echo $data['3']; ?>" title=""><?php echo $i; ?></a>
                                </li>
                                <?php }; ?>
                            </ul>
                        </div>
