    ...
    <div id="wrapper" class="wp-inner clearfix">
		<form method="post" action="?modules=users&controllers=index&action=login" name="form-checkout">
			<div class="section" id="customer-info-wp">
				...
				<input type="submit" name="btn_submit" id="btn-submit" 
						value="Đăng nhập" style="height: 40px;
                                                border-radius: 60px;
                                                width: 150px;
                                                color: green;
                                                border-color: white;
        ...
        <div class="section" id="customer-info-wp">
			...
			<div class="section-detail">
                <form method="POST" action="?modules=users&controllers=index&action=crateAcount" name="form-checkout">
	                ...
	                <input type="submit" name="btn_submit_crate" 
						id="btn-submit" value="Tạo" style="height: 40px;
                                                        border-radius: 60px;
                                                        width: 150px;
                                                        color: green;
                                                        border-color: white;
