            ...
            <div id="container">
                <div id="header-wp">
                    <div id="head-body" class="clearfix">
                            <!-- Logo -->
                            <a href="?modules=home" title="" id="logo" class="">
                            ...
                            <div id="main-menu-wp" class="fl-left">
                                <ul id="main-menu" class="clearfix">
                                    <li><a href="?modules=home" title="">Trang chủ</a></li>
                                    <li><a href="?modules=blogs&action=list" title="">Blog</a></li>
                                    <li><a href="?modules=contacts&action=introduce" title="">Giới thiệu</a></li>
                                    <li><a href="?modules=contacts&action=contact" title="">Liên hệ</a></li>
                                </ul>
                            </div>
                            <!-- Search -->
                                ...
                                <div id="user-wp">
                                    ...
                                    <div id="dropdown">
                                        ...
                                        { ?>
                                            ...
                                            <a href="?modules=users&controllers=index&action=info" title="">Thông tin tài khoản</a>
                                            <a href="?modules=users&action=logout" title="" class="logout">Đăng xuất</a>
                                        <?php 
                                        } else 
                                        { 
                                            echo "Bạn chưa đăng nhập.";?>
                                            <a href="?modules=users&action=index" title="Đăng nhập">Đăng nhập/ Đăng ký</a>
                                        <?php 
                                        } ?>
                                    </div>
                                </div>
