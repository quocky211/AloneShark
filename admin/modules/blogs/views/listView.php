...
<div id="main-content-wp" class="list-post-page">
    <div class="wrap clearfix">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-operation ">
                                            ...
                                            <li><a onclick="return Del('<?php echo $value['id'];?>')" href="?modules=blogs&controllers=index&action=delete&id=<?php echo $value['id']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
                                </tr>
                                <?php }; ?>
        ...
        <script>
            function Del(id) {
                return confirm ("Bạn có chắn chắn xóa blogs: "+ id + " không ?");
            }
        </script>         
