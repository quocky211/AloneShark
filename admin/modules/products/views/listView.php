                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-operation ">
                                            ...
                                            <li><a onclick="return Del('<?php echo $value['name'];?>')" href="?modules=products&controllers=index&action=delete&id=<?php echo $value['id'] ;?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
                                </tr>
                                <?php }; ?>
...
<script>
            function Del(name) {
                return confirm ("Bạn có chắn chắn xóa: "+ name + " không ?");
            }
</script>  
<?php get_footer(); ?>